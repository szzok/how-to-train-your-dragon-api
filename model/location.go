...
var Locations = []Location{
	...
	{ID: 8, Name: "Wingmaiden Island", Inhabitants: "Wingmaidens", Description: "Wingmaiden Island is the home of the Wingmaidens and nesting grounds to Razorwhip dragons. It makes its first appearance in Dragons: Race to the Edge, Season 5, in the episode Snotlout's Angels."},
}
